...
public class Task1 {
     ...
     *
     */
    public static List<Integer> getIntegersDivisableBy(int divider, int max) {
     ...
     */
    public static List<Integer> getPrimesAsArray(int min, int max) {
     ...
     * Formula: x = n * Math.PI
     */
    public static List<Double> getMultiplesOfPi(int min, int max) {
        return IntStream.range(min, max + 1)
                .mapToDouble(d -> d)
                .map(d -> d * Math.PI)
                .boxed()
